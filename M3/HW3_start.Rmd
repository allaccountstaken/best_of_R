...
b. Produce a scatterplot of the two variables. How would you describe the relationship between the number of copiers serviced and the time spent by the service
person?
...
ggplot(Data, aes(x=Minutes, y=Serviced))+
  ...
  labs(x="Minutes", 
       y="Serviced", 
       title="Scatterplot of number of serviced deviced and time spent")
...
#### Notes:
B1_hat is positive and significant, it can be interpreted as an increase in number Serviced per unit of time spent.
