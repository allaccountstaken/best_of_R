...
### Comment on appearance of the plot: 2 influencial observations on the far right may cause a problem when fitting the least squares regression line. However, it is not obvious if assumptions of SLR were actually violated. 
